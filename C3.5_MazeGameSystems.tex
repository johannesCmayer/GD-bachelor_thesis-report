...
\begin{figure}
  ...
  \includegraphics[width=0.5\textwidth]{images/game_systems/SonarBright.png}
...
\subsection{Speeder}
\Cref{Speeder} shows the simplest enemy, the speeder. He moves forward with a constant velocity. This enemy emits a two sounds. One can only be heard by the player if the enemy is moving directly at him.
...
\begin{figure}[p]
  \centering
  \includegraphics[height=0.29\textheight]{images/game_systems/Shoot1.png} \\[3mm]
  \includegraphics[height=0.29\textheight]{images/game_systems/Shoot2.png} \\[3mm]
