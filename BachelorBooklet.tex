...
{Shrouded Mirror\\[0pt]
{\Large Neural Scene Rendering in interactive environments}\\[0pt]
...
During the bachelor thesis the following things where produced:

\begin{itemize}
\item{Data generation environment}
\item{Data processing pipeline}
\item{Scene rendering neural network model}
\item{}
\end{itemize}
