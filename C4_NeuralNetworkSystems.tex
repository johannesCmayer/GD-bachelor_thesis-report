...
Use unity camera to make screenshots to texture,
batch capture for efficiency
create list of how many pictures to capture of each specified resolution
save to file, automatic directory organization,
variable resoluiot
variable camera axis rotations
capture area specification
capture are environment specification
